...
export class SystemTypeService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/systemtype/All');
  }
  ...
  public getByCode = (code: string) => {
    return this.repositoryHelper.get('api/systemtype/getByCode?code=' + code);
  }

  

  public create = (body: any) => {
    return this.repositoryHelper.post('api/systemtype/CreateSystemType', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/systemtype/UpdateSystemType', body);
  }
  ...
  public toggle = (id: number , enable : boolean) => {
    return this.repositoryHelper.put('api/systemtype/EnableSystemType/' + id+"/"+enable, null);
  }

  public default = (id: number,enable : boolean) => {
    return this.repositoryHelper.put('api/systemtype/DefaultSystemType/' + id+"/"+enable, null);
  }
