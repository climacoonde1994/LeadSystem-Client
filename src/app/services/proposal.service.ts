...
export class ProposalService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/proposal/All');
  }
  ...
  public create = (body: any) => {
    return this.repositoryHelper.post('api/proposal/CreateProposal', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/proposal/UpdateProposal', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/proposal/delete?id=' + id);
  }
