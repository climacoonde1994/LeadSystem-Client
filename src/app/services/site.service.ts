...
export class SiteService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/site/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/site/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/site/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/site/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/site/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/site/toggle?id=' + id, null);
  }
