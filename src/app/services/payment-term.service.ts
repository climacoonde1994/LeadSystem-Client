...
export class PaymentTermService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/paymentTerm/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/paymentTerm/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/paymentTerm/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/paymentTerm/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/paymentTerm/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/paymentTerm/toggle?id=' + id, null);
  }

  public default = (id: number) => {
    return this.repositoryHelper.put('api/paymentTerm/default?id=' + id, null);
  }

  public getDueTypes = () => {
    return this.repositoryHelper.get('api/paymentTerm/getDueTypes');
  }
