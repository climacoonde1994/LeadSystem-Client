...
export class CutPasteService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/cutpaste/All');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/cutpaste/getById?id=' + id);
  }

  public getByLeadId = (id: string) => {
    return this.repositoryHelper.get('api/cutpaste/ByLeadId/' + id);
  }

  public getByCode = (code: string) => {
    return this.repositoryHelper.get('api/cutpaste/getByCode?code=' + code);
  }

  

  public create = (body: any) => {
    return this.repositoryHelper.post('api/cutpaste/CreateCutPaste', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/cutpaste/UpdateCutPaste', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/cutpaste/delete?id=' + id);
  }
