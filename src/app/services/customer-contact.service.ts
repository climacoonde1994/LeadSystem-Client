...
function matches(item: any, term: string, pipe: PipeTransform) {
  return item.fullName.toLowerCase().includes(term.toLowerCase()) || item.emailAddress1.toLowerCase().includes(term.toLowerCase());
}
...
export class CustomerContactService {
  ...
  public loadList = (id: number) => {
    this.getListByCustomerId(id).subscribe(response => {
      this.$search.pipe(
  ...
  public getListByCustomerId = (id: number) => {
    return this.repositoryHelper.get('api/customerContact/getList?id=' + id);
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/customerContact/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/customerContact/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/customerContact/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/customerContact/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/customerContact/toggle?id=' + id, null);
  }
