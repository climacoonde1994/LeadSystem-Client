...
export class EndUserService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/endUser/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/endUser/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/endUser/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/endUser/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/endUser/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/endUser/toggle?id=' + id, null);
  }
