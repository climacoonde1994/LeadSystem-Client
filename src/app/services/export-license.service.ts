...
export class ExportLicenseService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/exportLicense/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/exportLicense/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/exportLicense/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/exportLicense/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/exportLicense/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/exportLicense/toggle?id=' + id, null);
  }

  public default = (id: number) => {
    return this.repositoryHelper.put('api/exportLicense/default?id=' + id, null);
  }
}
