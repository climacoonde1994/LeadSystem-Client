...
export class EmployeeService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/employee/All');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/employee/ById/' + id);
  }

  public getByEmployeeId = (id: number) => {
  ...
  public getByCode = (code: string) => {
    return this.repositoryHelper.get('api/employee/getByCode?code=' + code);
  }

  

  public create = (body: any) => {
    return this.repositoryHelper.post('api/employee/CreateEmployee', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/employee/UpdateEmployee', body);
  }
  ...
  public toggle = (id: number , enable : boolean) => {
    return this.repositoryHelper.put('api/employee/EnableEmployee/' + id+"/"+enable, null);
  }

  public default = (id: number,enable : boolean) => {
    return this.repositoryHelper.put('api/employee/DefaultEmployee/' + id+"/"+enable, null);
  }
