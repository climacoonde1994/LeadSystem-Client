...
export class ShippingTypeService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/shippingType/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/shippingType/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/shippingType/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/shippingType/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/shippingType/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/shippingType/toggle?id=' + id, null);
  }

  public default = (id: number) => {
    return this.repositoryHelper.put('api/shippingType/default?id=' + id, null);
  }
