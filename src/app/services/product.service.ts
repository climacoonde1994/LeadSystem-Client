...
function matches(item: any, term: string, pipe: PipeTransform) {
  return item.partNumber.toLowerCase().includes(term.toLowerCase());
}
...
export class ProductService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/product/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/product/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/product/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/product/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/product/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/product/toggle?id=' + id, null);
  }
