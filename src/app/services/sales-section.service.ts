...
export class SalesSectionService {
  ...
  public loadList = (id: number) => {
    this.getListBySalesDepartmentId(id).subscribe(response => {
      this.$search.pipe(
  ...
  public getListBySalesDepartmentId = (id: number) => {
    return this.repositoryHelper.get('api/salesSection/getListBySalesDepartmentId?id=' + id);
  }

  public getList = () => {
    return this.repositoryHelper.get('api/salesSection/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/salesSection/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/salesSection/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/salesSection/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/salesSection/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/salesSection/toggle?id=' + id, null);
  }
