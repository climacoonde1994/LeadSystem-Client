...
export class SalesTermService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/salesTerm/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/salesTerm/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/salesTerm/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/salesTerm/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/salesTerm/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/salesTerm/toggle?id=' + id, null);
  }

  public getDueTypes = () => {
    return this.repositoryHelper.get('api/salesTerm/getDueTypes');
  }
