...
export class FiscalYearService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/fiscalYear/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/fiscalYear/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/fiscalYear/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/fiscalYear/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/fiscalYear/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/fiscalYear/toggle?id=' + id, null);
  }
