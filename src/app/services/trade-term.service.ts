...
export class TradeTermService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/tradeTerm/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/tradeTerm/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/tradeTerm/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/tradeTerm/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/tradeTerm/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/tradeTerm/toggle?id=' + id, null);
  }

  public default = (id: number) => {
    return this.repositoryHelper.put('api/tradeTerm/default?id=' + id, null);
  }
