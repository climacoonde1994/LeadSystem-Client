...
export class DepartmentService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/department/All');
  }
  ...
  public getByCode = (code: string) => {
    return this.repositoryHelper.get('api/department/getByCode?code=' + code);
  }

  

  public create = (body: any) => {
    return this.repositoryHelper.post('api/department/CreateDepartment', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/department/UpdateDepartment', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/department/DeleteDepartment/' + id);
  }

  public toggle = (id: number , enable : boolean) => {
    return this.repositoryHelper.put('api/department/EnableDepartment/' + id+"/"+enable, null);
  }

  public default = (id: number,enable : boolean) => {
    return this.repositoryHelper.put('api/department/DefaultDepartment/' + id+"/"+enable, null);
  }
