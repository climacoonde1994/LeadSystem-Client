...
export class ClientService {
  ...
  public create = (body: any) => {
    return this.repositoryHelper.post('api/client/CreateClient', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/client/UpdateClient', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/client/DeleteClient/' + id);
  }

  public toggle = (id: number , enable : boolean) => {
    return this.repositoryHelper.put('api/client/EnableClient/' + id+"/"+enable, null);
  }

  public default = (id: number,enable : boolean) => {
    return this.repositoryHelper.put('api/client/DefaultClient/' + id+"/"+enable, null);
  }
