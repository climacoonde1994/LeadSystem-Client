...
export class SalesDepartmentService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/salesDepartment/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/salesDepartment/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/salesDepartment/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/salesDepartment/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/salesDepartment/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/salesDepartment/toggle?id=' + id, null);
  }
