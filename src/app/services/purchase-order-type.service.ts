...
export class PurchaseOrderTypeService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/purchaseOrderType/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/purchaseOrderType/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/purchaseOrderType/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/purchaseOrderType/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/purchaseOrderType/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/purchaseOrderType/toggle?id=' + id, null);
  }
