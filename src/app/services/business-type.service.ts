...
export class BusinessTypeService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/businessType/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/businessType/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/businessType/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/businessType/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/businessType/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/businessType/toggle?id=' + id, null);
  }
