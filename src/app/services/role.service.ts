...
export class RoleService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/role/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/role/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/role/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/role/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/role/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/role/toggle?id=' + id, null);
  }
