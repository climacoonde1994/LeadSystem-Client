...
export class SourceService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/source/All');
  }
  ...
  public getByCode = (code: string) => {
    return this.repositoryHelper.get('api/source/getByCode?code=' + code);
  }

  

  public create = (body: any) => {
    return this.repositoryHelper.post('api/source/CreateSource', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/source/UpdateSource', body);
  }
  ...
  public toggle = (id: number , enable : boolean) => {
    return this.repositoryHelper.put('api/source/EnableSource/' + id+"/"+enable, null);
  }

  public default = (id: number,enable : boolean) => {
    return this.repositoryHelper.put('api/source/DefaultSource/' + id+"/"+enable, null);
  }
