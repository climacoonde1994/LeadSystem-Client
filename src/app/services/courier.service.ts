...
export class CourierService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/courier/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/courier/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/courier/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/courier/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/courier/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/courier/toggle?id=' + id, null);
  }

  public default = (id: number) => {
    return this.repositoryHelper.put('api/courier/default?id=' + id, null);
  }
