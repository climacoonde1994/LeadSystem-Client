...
export class VendorContactService {
  ...
  public getListByVendorId = (id: number) => {
    return this.repositoryHelper.get('api/vendorContact/getList?id=' + id);
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/vendorContact/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/vendorContact/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/vendorContact/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/vendorContact/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/vendorContact/toggle?id=' + id, null);
  }
