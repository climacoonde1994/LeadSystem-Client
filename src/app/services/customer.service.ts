...
export class CustomerService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/customer/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/customer/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/customer/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/customer/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/customer/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/customer/toggle?id=' + id, null);
  }
