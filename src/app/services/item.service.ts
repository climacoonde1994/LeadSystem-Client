...
function matches(item: any, term: string, pipe: PipeTransform) {
  return item.partNo.toLowerCase().includes(term.toLowerCase()) || item.description1.toLowerCase().includes(term.toLowerCase());
}
...
export class ItemService {
  ...
  public loadList = (id: number) => {
    this.getListByVendorId(id).subscribe(response => {
      this.$search.pipe(
  ...
  public getListByVendorId = (id: number) => {
    return this.repositoryHelper.get('api/item/getListByVendorId?id=' + id);
  }

  public getList = () => {
    return this.repositoryHelper.get('api/item/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/item/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/item/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/item/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/item/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/item/toggle?id=' + id, null);
  }
