...
function matches(item: any, term: string, pipe: PipeTransform) {
  return item.customerReferenceNo.toLowerCase().includes(term.toLowerCase());
}
...
export class PurchaseOrderService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/purchaseOrder/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/purchaseOrder/getById?id=' + id);
  }

  public getSingle = (id: number) => {
    return this.repositoryHelper.get('api/purchaseOrder/getSingle?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/purchaseOrder/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/purchaseOrder/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/purchaseOrder/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/purchaseOrder/toggle?id=' + id, null);
  }

  public uploadFile(id: number, description: string, body: FormData) {
    return this.repositoryHelper.upload('api/purchaseOrder/uploadFile?id=' + id + '&description=' + description, body);
  }
