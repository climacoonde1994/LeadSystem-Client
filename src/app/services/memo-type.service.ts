...
export class MemoTypeService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/memoType/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/memoType/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/memoType/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/memoType/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/memoType/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/memoType/toggle?id=' + id, null);
  }
