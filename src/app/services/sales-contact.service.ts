...
import { SalesContactType } from '../variables/sales-contact-type.enum';
...
export class SalesContactService {
  ...
  public loadList = (id: number) => {
    this.getListBySalesSectionId(id).subscribe(response => {
      this.$search.pipe(
  ...
  public getListBySalesSectionId = (id: number) => {
    return this.repositoryHelper.get('api/salesContact/getListBySalesSectionId?id=' + id);
  }

  public getList = () => {
    return this.repositoryHelper.get('api/salesContact/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/salesContact/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/salesContact/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/salesContact/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/salesContact/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/salesContact/toggle?id=' + id, null);
  }

  public getSalesContactType = (id: number) : string => {
    return SalesContactType[id];
  }
