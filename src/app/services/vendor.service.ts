...
export class VendorService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/vendor/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/vendor/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/vendor/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/vendor/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/vendor/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/vendor/toggle?id=' + id, null);
  }
