...
export class SpecialtyService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/specialty/All');
  }
  ...
  public getByCode = (code: string) => {
    return this.repositoryHelper.get('api/specialty/getByCode?code=' + code);
  }

  

  public create = (body: any) => {
    return this.repositoryHelper.post('api/specialty/CreateSpecialty', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/specialty/UpdateSpecialty', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/specialty/DeleteSpecialty/' + id);
  }

  public toggle = (id: number , enable : boolean) => {
    return this.repositoryHelper.put('api/specialty/EnableSpecialty/' + id+"/"+enable, null);
  }

  public default = (id: number,enable : boolean) => {
    return this.repositoryHelper.put('api/specialty/DefaultSpecialty/' + id+"/"+enable, null);
  }
