...
export class ContactService {
  ...
  public getById = (id: number) => {
    return this.repositoryHelper.get('api/contact/ByContactId/' + id);
  }

 
  public getByCode = (code: string) => {
    return this.repositoryHelper.get('api/contact/getByCode?code=' + code);
  }

  

  public create = (body: any) => {
    return this.repositoryHelper.post('api/contact/CreateContact', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/contact/UpdateContact', body);
  }
  ...
  public toggle = (id: number , enable : boolean) => {
    return this.repositoryHelper.put('api/contact/EnableContact/' + id+"/"+enable, null);
  }

  public default = (id: number,enable : boolean) => {
    return this.repositoryHelper.put('api/contact/DefaultContact/' + id+"/"+enable, null);
  }
