...
export class PurchaseOrderStatusService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/purchaseOrderStatus/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/purchaseOrderStatus/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/purchaseOrderStatus/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/purchaseOrderStatus/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/purchaseOrderStatus/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/purchaseOrderStatus/toggle?id=' + id, null);
  }
