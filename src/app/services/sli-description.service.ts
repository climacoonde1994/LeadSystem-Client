...
export class SLIDescriptionService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/sliDescription/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/sliDescription/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/sliDescription/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/sliDescription/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/sliDescription/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/sliDescription/toggle?id=' + id, null);
  }
