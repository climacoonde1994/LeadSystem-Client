...
function matches(item: any, term: string, pipe: PipeTransform) {
  ...
  item.ZIP.toLowerCase().includes(term.toLowerCase());
}
...
export class CityService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/city/All');
  }
  ...
  public getByCode = (code: string) => {
    return this.repositoryHelper.get('api/city/getByCode?code=' + code);
  }

  

  public create = (body: any) => {
    return this.repositoryHelper.post('api/city/CreateCity', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/city/UpdateCity', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/city/DeleteCity/' + id);
  }

  public toggle = (id: number , enable : boolean) => {
    return this.repositoryHelper.put('api/city/EnableCity/' + id+"/"+enable, null);
  }

  public default = (id: number,enable : boolean) => {
    return this.repositoryHelper.put('api/city/DefaultCity/' + id+"/"+enable, null);
  }
