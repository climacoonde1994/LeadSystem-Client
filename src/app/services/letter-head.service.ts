...
export class LetterHeadService {
  ...
  public getList = () => {
    return this.repositoryHelper.get('api/letterHead/getList');
  }

  public getById = (id: number) => {
    return this.repositoryHelper.get('api/letterHead/getById?id=' + id);
  }

  public create = (body: any) => {
    return this.repositoryHelper.post('api/letterHead/create', body);
  }

  public update = (body: any) => {
    return this.repositoryHelper.put('api/letterHead/update', body);
  }

  public delete = (id: number) => {
    return this.repositoryHelper.delete('api/letterHead/delete?id=' + id);
  }

  public toggle = (id: number) => {
    return this.repositoryHelper.put('api/letterHead/toggle?id=' + id, null);
  }

  public default = (id: number) => {
    return this.repositoryHelper.put('api/letterHead/default?id=' + id, null);
  }
